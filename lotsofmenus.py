...
menuItem1 = MenuItem(name="Cheese Pizza", description="Juicy grilled veggie patty with tomato mayo and lettuce",
...
restaurant1 = Restaurant(name="Super Stir Fry")
...
menuItem5 = MenuItem(name="Beef Noodle Soup", description="A Chinese noodle soup made of stewed or red braised beef, beef broth, vegetables and Chinese noodles.",
                     price="14", course="Entree", restaurant=restaurant1)
